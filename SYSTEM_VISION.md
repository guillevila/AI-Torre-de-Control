...
| D25 | Existe el canal **«Responder desde la Torre»**: al terminar un turno, la Torre puede enseñar la respuesta del asistente y esperar la tuya (ventana configurable, apagada por omisión). Si contestas, tu texto reengancha la conversación en su sesión por el mecanismo oficial de los hooks de Stop. La respuesta que se enseña **no se guarda en ningún sitio** (D5-ter: se lee solo la última respuesta de la cola de la transcripción, se enseña en memoria y desaparece) | Petición literal del dueño el 5/8/2026: «me envía un output Claude, la app me pone un pop-up para que responda, respondo y se cierra». Coste declarado: mientras la tarjeta espera, esa sesión no da su turno por cerrado. Razonada en [ADR-011](docs/decisiones/ADR-011-responder-desde-la-torre.md) |
